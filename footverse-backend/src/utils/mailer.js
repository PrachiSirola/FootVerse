...
function baseTemplate(title, bodyHtml) {
  return `
  <div style="background:#F7F4EF;padding:32px 0;font-family:Georgia,'Times New Roman',sans-serif-serif">
    <div style="max-width:480px;margin:0 auto;background:#fff;border-radius:16px;overflow:hidden;box-shadow:0 10px 40px -20px rgba(51,35,26,0.35)">
      ...
      <div style="padding:18px 32px;border-top:1px solid #eee;font-size:12px;color:#6E655C;font-family:Arial,sans-serif">
...
export async function sendOtpEmail(to, otp, name = "") {
  const body = `
    <p style="font-family:Arial,sans-serif;color:#6E655C;font-size:15px;line-height:1.6">
    ...
    <div style="margin:24px 0;text-align:center">
      <span style="display:inline-block;background:#F1ECE2;color:#33231A;font-size:34px;
        letter-spacing:10px;font-weight:700;padding:16px 28px;border-radius:12px;font-family:Arial,sans-serif">
        ${otp}
      </span>
    </div>`;
...
export async function sendResetEmail(to, resetUrl, name = "") {
  const body = `
    <p style="font-family:Arial,sans-serif-serif;color:#6E655C;font-size:15px;line-height:1.6">
    ...
    <div style="margin:24px 0;text-align:center">
      <a href="${resetUrl}" style="display:inline-block;background:#33231A;color:#fff;
        ...
        font-family:Arial,sans-serif;font-weight:600">Reset Password</a>
    </div>
    <p style="font-family:Arial,sans-serif;color:#6E655C;font-size:12px;word-break:break-all">
