export const TESTIMONIALS = [
  { name: "Ananya Rao", city: "Bengaluru", rating: 5, quote: "The quality genuinely surprised me — my running pair has survived six months of daily 5Ks and still looks new. Delivery was quick too." },
  { name: "Kabir Mehta", city: "Mumbai", rating: 5, quote: "Bought formal Oxfords for my wedding week. Zero break-in pain, endless compliments. FootVerse is now my default for footwear." },
  { name: "Sarah D'Souza", city: "Pune", rating: 4, quote: "Loved the fit guide and easy returns. Exchanged a size without any drama — the whole experience feels premium end to end." },
];

export const FAQS = [
  { q: "What is your return and exchange policy?", a: "We offer easy 30-day returns and size exchanges on all unworn footwear in original packaging. Refunds are processed to your original payment method within 5–7 business days of pickup." },
