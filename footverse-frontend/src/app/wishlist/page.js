  ...
  return (
    <>
      ...
      <div className="mx-auto max-w-[1500px] px-5 py-10 sm:px-8">
        <h1 className="font-sans-serif text-4xl font-bold text-[#33231A]">Your Wishlist ❤️</h1>

        {ready && !loading && cards.length === 0 ? (
          <div className="mx-auto max-w-lg py-20 text-center">
            <p className="font-sans-serif text-2xl font-bold text-[#33231A]">Nothing saved yet</p>
